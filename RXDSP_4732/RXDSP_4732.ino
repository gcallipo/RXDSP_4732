...
// IK8YFW - 2025
// RXDSP_4732 
// Based on custom ATS_EX project
// by  By Goshante
//*************************************
// ----------------------------------------------------------------------
...
void setup()
{
   ...
   // g_voltagePinConnnected = analogRead(BATTERY_VOLTAGE_PIN) > 300;
    ...
    if ((PINC & (1 << (ENCODER_BUTTON - 14))))  //yfw
    {
    ...
    {
        oledPrint("RX DSP 4732", 0, 0, DEFAULT_FONT, true);
        oledPrint("RECEIVER", 16, 2);
        oledPrint("IK8YFW 2025", 12, 4);
        oledPrint("v. 1.0", 12, 6);
        delay(2000);
    }
    oled.clear();
