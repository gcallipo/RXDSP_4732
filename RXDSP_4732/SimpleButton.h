...
#define BUTTONTIME_LONGPRESS1         1*20*16   // Time (ms) after debounce a button needs to be pressed to be considered longpressed
#define BUTTONTIME_LONGPRESSREPEAT    4*3*16   // Time (ms) between consecutive longpress events
#define BUTTONTIME_RELEASEDEBOUNCE    2*4*16   // How long to debounce rising slope of pin (in ms), i. e. Button going to released
